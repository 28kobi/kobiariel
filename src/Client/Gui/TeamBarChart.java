...
public class TeamBarChart extends ApplicationFrame {
    ...
    public TeamBarChart(final String title,statistic statisticQ) {
   ...
   //     this.thing=thing;
    ...
    private CategoryDataset createDataset() {
        ...
        final String series1 = "number of ahtlete in team";
        final String series2 = "precent of how many preformed";
        final String series3 = "precent of how many  didnt preformed";
        
        
        final String category1 = "athlete in team";
        final String category2 =  "preformed the training(precenct) ";
        final String category3 =  "didnt preformed the training(precent)";
 
        // column keys...
        
     
        	dataset.addValue(this.statisticQ.getAthleteInTeam(),series1,category1);
        	dataset.addValue(this.statisticQ.getPrecentDidTheTraining(),series2,category2);
        	dataset.addValue(this.statisticQ.getPrecentDidntDoTheTraining(),series3,category3);
        return dataset;
